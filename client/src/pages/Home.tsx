    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative h-screen max-h-[900px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            DOMINATE THE <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">SEAS</span>
          </motion.h1>
          ...
          >
            Join the elite Blox Fruits crew. Competitive wars, daily tournaments, and a community of top-tier players.
          </motion.p>
          
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="h-14 px-8 text-lg bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/25" asChild>
      ...
      <section className="py-32 container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold font-display mb-4">Why Join Us?</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">We aren't just a crew; we're a powerhouse. Here's what we offer to our dedicated members.</p>
        </div>
  ...
  return (
    <div className="group rounded-2xl overflow-hidden bg-secondary border border-white/5 hover:border-primary/40 transition-all duration-300">
      ...
      <div className="p-6 relative z-20 -mt-12">
        <h3 className="text-xl font-bold font-display mb-2 text-white group-hover:text-primary transition-colors">{title}</h3>
